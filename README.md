...
## Code and diagram view

View or edit the program in JavaScript or Python and see the changes reflected in the diagram.

## Step-by-step execution

Follow each step as the program runs and see how its variables change.
