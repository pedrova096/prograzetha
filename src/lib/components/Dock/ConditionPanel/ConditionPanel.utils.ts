...
import { FormFields, type ConditionForm } from './ConditionPanel.types';

export const createConditionPanelData = (
  data?: Partial<ConditionForm>,
): ConditionForm => ({
